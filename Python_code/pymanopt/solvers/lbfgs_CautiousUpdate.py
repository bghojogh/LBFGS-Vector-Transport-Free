...
class LBFGS_CautiousUpdate(Solver):
    """
    ...
    def __init__(self, linesearch=None, *args, **kwargs):
        ...
        super().__init__(minstepsize=1e-20)
    ...
    def solve(self, problem, x=None, reuselinesearch=False):
        ...
        while True:
            ...
            inner_s_s = man.norm(x, s_tPlus1) ** 2
            cautious_condition = ((inner_s_y/inner_s_s) >= self._monotonic_function(gradnorm))
    ...
    def _monotonic_function(self, t):
        # In rlbfgs.m of manopt, it is written that f(t) = 1e-4*t is better than f(t) = t for bfgs
        return 1e-4 * t