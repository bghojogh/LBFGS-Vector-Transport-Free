...
%     lsmem.transg = problem.M.transp(x, newx, grad, d, new_alpha, store); %--> Benyamin commented it (because store was undefined)
    lsmem.transg = problem.M.transp(x, newx, grad); %
